...
public class SaveWagesForEachCompany {
    ...
    //Constructor
    public SaveWagesForEachCompany(String company, int EMP_RATE_PER_HOUR, int workingDaysPerMonth, int maxWorkingHours){
    ...
    public static void main(String args[]) {
        ...
        SaveWagesForEachCompany company1 = new SaveWagesForEachCompany("Reliance", 10, 30, 100);
        company1.companyWage();
        SaveWagesForEachCompany company2 = new SaveWagesForEachCompany("Axis", 10, 30, 300);
